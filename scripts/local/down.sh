...
_set_default_environment()
{
    ...
    export ORCHIDARIUM_CONFIG_DIR="${ORCHIDARIUM_CONFIG_DIR:-./.orchidarium/config}"
    ...
    export ORCHIDARIUM_STATE_PATH="${ORCHIDARIUM_STATE_PATH:-/opt/orchidarium/config/state.json}"
