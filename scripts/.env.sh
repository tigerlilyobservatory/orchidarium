...
ORCHIDARIUM_MONITORING_URL="${ORCHIDARIUM_MONITORING_URL:-https://grafana:3000}"
ORCHIDARIUM_READINESS_URL="${ORCHIDARIUM_READINESS_URL:-http://127.0.0.1:${HEALTHCHECK_PORT}/ready}"
ORCHIDARIUM_DOCKER_SUBNET="${ORCHIDARIUM_DOCKER_SUBNET:-172.31.240.0/24}"
ORCHIDARIUM_CONFIG_DIR="${ORCHIDARIUM_CONFIG_DIR:-./.orchidarium}"
ORCHIDARIUM_RUNTIME_DIR='/tmp/orchidarium'
ORCHIDARIUM_STATE_PATH="${ORCHIDARIUM_STATE_PATH:-/opt/orchidarium/.orchidarium/state.json}"
...
export ORCHIDARIUM_CONFIG_DIR
export ORCHIDARIUM_DOCKER_SUBNET
export ORCHIDARIUM_MONITORING_URL
export ORCHIDARIUM_READINESS_URL
export ORCHIDARIUM_RUNTIME_DIR
export ORCHIDARIUM_STATE_PATH
export TMPDIR
